...
- **--skip-dev**: Skip the development sub-loop. Outputs approved designs as final deliverable.
...
max_iterations = analysis_iters + design_iters + dev_iters + 2  # +2 for init + present
```
